...
* In LevelMaker.lua, generate a random-colored key and lock block (taken from keys_and_locks.png in 
   ...
   ? if x > width / 2 
   / ensure that pole is spawning on a ground
   ? Just dont spawn any holes or poles 12 tiles next to end of level
...
/ when player touches in any way the pole inisialize PlayState again
/ after initializing playstate again the level should get wider 
/ after initializing score should stay same
