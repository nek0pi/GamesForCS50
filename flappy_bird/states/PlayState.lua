...
function PlayState:init()
    ...
    self.timer = 0
    self.score = 0
    self.pauseimg = love.graphics.newImage('images/pause.png')
...
function PlayState:update(dt)
    if pause == 0 then
        ...
        if godmode == 0 then
            ...
            --implementing of a pause switch
...
function PlayState:render()
    ...
    if godmode == 1 then
        love.graphics.printf('Godmode is on', 0, 256, VIRTUAL_WIDTH, 'center')
    end
    ...
    if pause == 1 then
        ...
        love.graphics.draw(self.pauseimg, 190 , 100)
    end
